...
For the remote repository, make a github repository named House Price Prediction Seattle, then do;

```bash
git remote add origin git@github.com:kc-chaudhari/House Price Prediction Seattle.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── House Price Prediction Seattle	<- Your notebooks and scripts will live in the main project folder
